    ...
    return (
		...
		<div className="container flex flex-col items-center p-4 mx-auto md:p-8">
			...
			<div className="relative mt-6 mb-12">
				...
				<input type="search" name="Search" placeholder="Search..." className="w-full py-3 pl-12 text-sm rounded-full sm:w-96 focus:outline-none bg-gray-200 text-gray-800 focus:dark:bg-gray-900" />
			</div>
